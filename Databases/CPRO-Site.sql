...
(
	...
	--CONSTRAINT "PK_Codigo" PRIMARY KEY (Codigo),
	CONSTRAINT "FK_" FOREIGN KEY (CodigoSistema) REFERENCES Configuracao.Sistema(Codigo)
);
...
(
	...
	CONSTRAINT "PK_Usuario_Perfil" PRIMARY KEY (CodigoUsuario, CodigoPerfil),
	CONSTRAINT "FK_CodigoUsuario" FOREIGN KEY (CodigoUsuario) REFERENCES Cliente.Usuario(Codigo),
	CONSTRAINT "FK_CodigoPerfil" FOREIGN KEY (CodigoPerfil) REFERENCES Configuracao.Perfil(Codigo)
);
...
GRANT ALL PRIVILEGES ON CProSite.* TO postgres@localhost IDENTIFIED BY "recall00";
